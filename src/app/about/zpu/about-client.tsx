...
const ZPU = {
  ...
  favMovies: [
    ...
    { name: "Spider-Man: Brand New Day", image: "https://upload.wikimedia.org/wikipedia/en/9/9a/Spider-Man_Brand_New_Day_poster.jpg" },
    { name: "Spider-Man: No Way Home", image: "https://upload.wikimedia.org/wikipedia/en/0/00/Spider-Man_No_Way_Home_poster.jpg" },
    { name: "Spider-Man: Homecoming", image: "https://upload.wikimedia.org/wikipedia/en/f/f9/Spider-Man_Homecoming_poster.jpg" },
    { name: "Spider-Man: Far From Home", image: "https://upload.wikimedia.org/wikipedia/en/b/bd/Spider-Man_Far_From_Home_poster.jpg" },
    { name: "The Amazing Spider-Man 2", image: "https://upload.wikimedia.org/wikipedia/en/2/24/The_Amazing_Spider-Man_2_poster.jpg" },
    { name: "The Amazing Spider-Man", image: "https://upload.wikimedia.org/wikipedia/en/e/e0/The_Amazing_Spider-Man_%28film%29_poster.jpg" },
    { name: "Spider-Man (2002)", image: "https://upload.wikimedia.org/wikipedia/en/6/6c/Spider-Man_%282002_film%29_poster.jpg" },
    { name: "Spider-Man 2", image: "https://upload.wikimedia.org/wikipedia/en/4/4e/Spider-Man_2_USA_poster.jpg" },
    { name: "Spider-Man 3", image: "https://upload.wikimedia.org/wikipedia/en/7/7a/Spider-Man_3%2C_International_Poster.jpg" },
