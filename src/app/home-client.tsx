...
function DiscordLive({ online, members }: { online: number | null; members: number | null }) {
  ...
  return (
    <section className="discord-live-section">
      <a href="https://discord.gg/C3MpUNwsDU" target="_blank" rel="noreferrer" className="discord-live-card">
      ...
      <section className="hero" id="hero">
        ...
        <div className="hero-content">
          <div className="hero-badge">
            <span className="badge-discord-wrap">
            <svg width="13" height="13" viewBox="0 -28.5 256 256" fill="currentColor" className="badge-discord-icon" aria-hidden="true">
            ...
            <a href="https://discord.gg/C3MpUNwsDU" target="_blank" rel="noreferrer" className="badge-link">
              {t("heroBadgeJoin")}
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M7 17L17 7M7 7h10v10"/></svg>
            </a>
          </div>
      ...
      <section className="cta-section">
        <div className="cta-inner">
          ...
          <div className="cta-actions">
            ...
            <a href="https://discord.gg/C3MpUNwsDU" target="_blank" rel="noreferrer" className="btn-outline btn-large">{t("btnJoinDiscord")}</a>
          </div>
        </div>
      </section>
