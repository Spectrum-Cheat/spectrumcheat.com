...
const statusHighlights: { title: string; state: "Working" | "Waiting for Update"; noteKey: TranslationKey; image: string; href: string }[] = [
  ...
  { title: "Rivals",         state: "Working", noteKey: "gameNoteRivalsWorking", image: "https://tr.rbxcdn.com/180DAY-3df3c12313ef02c6656f378f110d72cd/256/256/Image/Webp/noFilter", href: "https://www.roblox.com/games/17625359962/RIVALS" },
...
export default function StatusClient() {
  ...
  const stats = [
    { value: "1",  label: t("statusWorkingTitle"), tone: "ok" },
    { value: "4",  label: t("statusWaitingTitle"), tone: "warn" },
    { value: "64", label: t("statusDiscTitle"),    tone: "muted" },
  ];
