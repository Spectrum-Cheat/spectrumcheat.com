...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "ZPU GitHub",
    "ZPU entrepreneur",
    "ZPU digital products",
    "ZPU online businesses",
    "ZPU Thailand",
    "ZPU Bangkok",
    "ZPU profile",
    "ZPU biography",
    "ZPU personal website",
    "ZPU contact",
    "ZPU portfolio",
    "ZPU projects",
    "ZPU achievements",
    ...
    "xZPUHigh Discord",
    "xZPUHigh GitHub",
    "xZPUHigh entrepreneur",
    "xZPUHigh digital products",
    "xZPUHigh online businesses",
    "xZPUHigh Thailand",
    "xZPUHigh Bangkok",
    "xZPUHigh profile",
    "xZPUHigh biography",
    "xZPUHigh personal website",
    "xZPUHigh contact",
    "xZPUHigh portfolio",
    "xZPUHigh projects",
    "xZPUHigh achievements",
    "xZPUHigh career",
    "xZPUHigh background",
    "xZPUHigh story",
    "xZPUHigh journey",
    ...
    "xZPUHigh education",
    "xZPUHigh awards",
    "xZPUHigh recognitions",
    "xZPUHigh media",
    "xZPUHigh interviews",
    "xZPUHigh appearances",
    "xZPUHigh events",
    "xZPUHigh collaborations",
    "xZPUHigh partnerships",
    "xZPUHigh community",
    "xZPUHigh followers",
...
// Structured data so search engines understand ZPU is a person (with aliases),
// helping queries like "Who is ZPU" / "Who is xZPUHigh" / "ใครคือ ZPU" find this page.
const personJsonLd = {
  ...
  description:
    "ZPU (xZPUHigh) is a founder, developer, and entrepreneur building digital products and online businesses, and the creator behind Spectrum Cheat.",
  worksFor: {
    "@type": "Organization",
    name: "Spectrum Cheat",
